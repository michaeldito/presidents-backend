...
const test = async () => describe('Suit', async function() {
  ...
  describe('#init()', async function() {    
    ...
    describe('validations', async function() {    
      ...
      it('name must be unique', async function() {
        ...
        const instance = new Suit(suit);
        const message = 'Error, expected `name` to be unique. Value: `Diamonds`';
      ...
      it('character must be unique', async function() {
        ...
        const instance = new Suit(suit);
        const message = 'Error, expected `character` to be unique. Value: `\u2666`';
